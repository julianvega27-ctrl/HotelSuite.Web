        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdDepartamento = table.Column<int>(type: "int", nullable: false),
                    IdEmpleadoAsignado = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TareasDepartamento", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TareasDepartamento_Departamentos_IdDepartamento",
                        column: x => x.IdDepartamento,
                        principalTable: "Departamentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TareasDepartamento_Empleados_IdEmpleadoAsignado",
                        column: x => x.IdEmpleadoAsignado,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TareasDepartamento_IdDepartamento",
                table: "TareasDepartamento",
                column: "IdDepartamento");

            migrationBuilder.CreateIndex(
                name: "IX_TareasDepartamento_IdEmpleadoAsignado",
                table: "TareasDepartamento",
                column: "IdEmpleadoAsignado");
        }
